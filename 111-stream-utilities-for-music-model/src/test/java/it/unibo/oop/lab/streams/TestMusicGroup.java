...
final class TestMusicGroup {
    ...
    void testOrderedSongNames() {
        final List<String> result = Arrays.asList(new String[] { // NOPMD used for testing
                "Black Dog",
                "Dazed and Confused",
                ...
                "Whole Lotta Love" }); // NOPMD used for testing
    ...
    void testAlbumInYear() {
        final List<String> result = Arrays.asList(new String[] { II, I }); // NOPMD used for testing
